...
Markit is a simple **note-taking app** that uses **Markdown** syntax to format your notes.
...
Following there's a quick overview of the currently supported Markdown syntax in Markit.
...
Here are all the heading formats currently supported by **_Markit_**:
